  ...
  return (
    <div className="page-content">
      ...
      <p className="text-start p-3">
        KTP brothers span many different majors, across several departments and
        colleges. The main focuses are on Data Science, Computer Science, and
        Engineering. Click on an icon to learn about that particular course.
      </p>
