    ...
    const [internshipResources] = useState([
        {
            ...
            resources: [
                ...
                { name: "BU On-Campus Research Opportunities", url: "https://www.bu.edu/urop/opportunities/on-campus-research/" },
                { name: "BU Connects", url: "https://buconnects.com/" },
                { name: "Handshake", url: "https://app.joinhandshake.com/login" },
        ...
        },
        {
            header: "GitHub Repos",
            resources: [
                { name: "Mission-Peace Repo", url: "https://github.com/mission-peace/interview" },
                { name: "Pitt CSC Internship Repo", url: "https://github.com/SimplifyJobs/Summer2025-Internships" }
            ]
        },
        {
            header: "Blogs and Videos",
            resources: [
                { name: "Mock Technical Interview", url: "https://www.youtube.com/watch?v=1qw5ITr3k9E&t=86s" }
            ]
        },
        ...
        <div className="w-3/4 mx-auto py-20">
            ...
            <div className="flex flex-wrap justify-around p-3">
                {internshipResources.map((section, idx) => (
                    <Card key={idx} className="m-4 w-96 text-start hover:bg-purple-200 hover:scale-105">
